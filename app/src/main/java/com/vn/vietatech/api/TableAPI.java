...
public class TableAPI extends AbstractAPI {
    ...
    public String moveTable(String currTable, String moveTable, String currTableGroup,
                            String posNo, String orderNo, String extNo, String splited, String cashierId)
            throws Exception {
        ...
        return String.valueOf(callService(params));
    }
